													...
													<c:forEach var="s_l" items="${subject_list}">
														<tr>
															...
															<td><button type="button"
																	...
																	onclick="location.href='${pageContext.request.contextPath}/teacher/teacher_4_3?openCourse_id=${c_l.openCourse_id}&openSubject_id=${s_l.openSubject_id}&exam_id=${s_l.exam_id}'">
