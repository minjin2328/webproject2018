							...
							<ul class="navbar-nav">
								...
								<li class="nav-item"><a class="nav-link"
									style="font-size: 12px; text-align: center;"><i
										class="fas fa-angle-right"></i></a></li>
								<li class="nav-item"><a class="nav-link"
									href="${pageContext.request.contextPath}/views/admin/admin_7/admin_sub2/admin_7_2_1.jsp"
									style="font-size: 12px; text-align: center;">수강생별 성적 조회</a></li>
								<li class="nav-item"><a class="nav-link"
									style="font-size: 12px; text-align: center;"><i
										class="fas fa-angle-right"></i></a></li>
								<li class="nav-item"><a class="nav-link"
									href="${pageContext.request.contextPath}/views/admin/admin_7/admin_sub2/admin_7_2_2.jsp"
									style="font-size: 12px; text-align: center;">수강 내역</a></li>
								<li class="nav-item"><a class="nav-link"
									style="font-size: 12px; text-align: center;"><i
										class="fas fa-angle-right"></i></a></li>
								<li class="nav-item active"><a class="nav-link"
									href="${pageContext.request.contextPath}/views/admin/admin_7/admin_sub2/admin_7_2_3.jsp"
												...
												<tbody>
													<tr>
														...
														<td><a href="#" data-toggle="popover"
															...
															data-content="<img src='${pageContext.request.contextPath}/resources/images/avatars/0.jpg'>">김선생</a></td>
														<td>20(20)</td>
														<td>18(30)</td>
														<td>50(50)</td>
														<td>88</td>
